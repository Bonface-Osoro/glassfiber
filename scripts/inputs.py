parameters = {                                            
    'regional': {
        ...
        'other_low_costs_usd': 15000,
        'other_high_costs_usd': 18000,
        'fiber_cable_low_kg_per_km' : 120,
        'fiber_cable_high_kg_per_km' : 150,
        'pcb_low_kg' : 0.5,
        'pcb_high_kg' : 0.7,
        'pvc_low_kg' : 0.8,
        'pvc_high_kg' : 1.2,
